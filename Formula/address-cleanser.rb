class AddressCleanser < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/joshuboi77/address-cleanser/releases/download/v1.0.21/address-cleanser-macos-arm64.zip"
      sha256 "5de7a2b688a80e6c522938fc2680a0609024717c7b049fe6425dae65e1cdcd52"
    else
