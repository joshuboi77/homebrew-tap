class AddressCleanser < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/joshuboi77/address-cleanser/releases/download/v1.0.27/address-cleanser-macos-arm64.zip"
      sha256 "e317fc2d581240b957c6437426b5421b051d097fe0b8974123a8db8ae51ff8f6"
    else
