class AddressCleanser < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/joshuboi77/address-cleanser/releases/download/v1.0.23/address-cleanser-macos-arm64.zip"
      sha256 "5f47675983f3f55b1533b5dc12aaf63ea6fe26d972c6e9ccdabfec231a736174"
    else
